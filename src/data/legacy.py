"""Legacy data fetcher module for backward compatibility (Phase 1).

This module preserves the original fetch_ohlcv function for backward compatibility
with existing code. New code should use YahooDataLoader instead.
"""
